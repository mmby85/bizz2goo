# Generated by Django 4.1.8 on 2024-12-27 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, choices=[('Technology', 'Technology'), ('Science', 'Science'), ('Business', 'Business'), ('Entertainment', 'Entertainment'), ('Sports', 'Sports'), ('Politics', 'Politics'), ('Health', 'Health')], null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='myapp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.CharField(blank=True, default='27 December 2024', max_length=100)),
                ('likes', models.IntegerField(blank=True, default=0, null=True)),
